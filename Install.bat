...
reg add "HKCU\Software\Classes\Directory\shell\AddonBuilderContextual\command" /VE /D "\"%appdata%\Build-with-AddonBuilder\Build.bat\" \"%AddonBuilder%\" \"%%1\"" /F
...
reg add "HKCU\Software\Classes\Directory\shell\AddonBuilderContextual_packOnly\command" /VE /D "\"%appdata%\Build-with-AddonBuilder\BuildWithArgs.bat\" \"%AddonBuilder%\" \"%%1\" -packonly" /F
